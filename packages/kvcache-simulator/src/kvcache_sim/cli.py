...
def build_parser() -> argparse.ArgumentParser:
    ...
    def add_run_arguments(command: argparse.ArgumentParser) -> None:
        ...
        command.add_argument("--warmup-fraction", type=float, default=0.5, help="Fraction of requests to skip before measuring hit rate (default: 0.5; use 0 for global hit rate)")
        command.add_argument("--include-underfilled", action="store_true", help="Include budget points even when the cache was not full before measurement; useful with --warmup-fraction 0 for global hit rate")
